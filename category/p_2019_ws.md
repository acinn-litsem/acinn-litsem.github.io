...
On **24th October** Carlo will present a paper by Staudacher et al. 2018 about modelling spatial snowdrift.

Please remind that we exceptionally meet in the computer room, 8th floor.
...
On **17th October** Rainer gave an overview about the publication process, journal metrics and predatory publishing. You'll find the presentation in the literature folder as well as an example paper from Njeri Mwaniki et al. 2018
